        ...
        <section id="content">
            ...
            <div class="allcp-form theme-primary mw320" id="login">
                ...
                <div class="panel mw320">
                    ...
                    <form method="post" action="?mmolog=add_login" id="form-login">
                            ...
                            <div class="section">
                                <div class="bs-component pull-left pt5">
                                    <div class="radio-custom radio-primary mb5 lh25">
                                       <a href="?mmolog=register">Don't have an account?</a>
                                    </div>
                                </div>
                                <input type="submit" name="submit" class="btn btn-bordered btn-primary pull-right" value="Log in">
                            </div>
                            <!-- /section -->
