        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item">Manage Users</li>
                </ol>
            </div>
        </header>
        <!-- /Topbar -->
                        ...
                        <div class="panel panel-visible">
                            <div class="panel-heading">
                                <div class="row nm">
                                    ...
                                    <button type="button" class="btn btn-rounded btn-primary btn-block right" style="width: 200px;">+ Tambah User Baru</button>
                                    </a>
                            </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-hover" id="datatable2" cellspacing="0"
                                        ...
                                        <tr>
                                            ...
                                            <th class="va-m">Username</th>
                                            <th class="va-m">Email</th>
                                            <th class="va-m">Alamat</th>
                                            <th class="va-m">Facebook</th>
                                            <th class="va-m">Discord</th>
                                            <th class="va-m">Skype</th>
                                        ...
                                        <tr>
                                            ...
                                            <td width="15%">
                                                <table>
                                                    <tr>
                                                        <td><a a href="?mmopilot=detailusers&id=<?php echo $value['idUser'];  ?>"><button type="button" class="btn btn-rounded btn-info btn-block" title="Detail"><span class="fa fa-eye"></span></button></a></td>
