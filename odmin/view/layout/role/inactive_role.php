        ...
        <header id="topbar" class="alt">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-current-item">Inactive Role User</li>
                </ol>
            </div>
        </header>
        <!-- /Topbar -->
                            ...
                            <div class="panel-body pn">
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="datatable2" cellspacing="0"
                                        ...
                                        <?php
                                            $kolo = "adasdsa";
                                            $ko = $db->prepare("select a.status,a.roleName,a.roleDesc,group_concat(c.menuName) as \"MenuList\",a.createdDate,a.createdBy,a.idRole from mmo_role a join tr_role_menu b on a.idRole = b.idRole join mmo_menu c on b.idMenu=c.idMenu where a.idRole!= :idrole and a.status!=1 group by a.idRole");
                                            ...
                                            <table>
                                                <tr>
                                                   ...
                                                   <!--<td> <a href=\"?mmopilot=edit_role&idRole=".$key->idRole."\"><button type=\"button\" class=\"btn btn-rounded btn-alert btn-block\" title=\"Edit\"><span class=\"fa fa-pencil-square-o\"></span></button></a></td>-->
                                                    ...
                                                    <td> <a href=\"?mmopilot=deactivate_role&idRole=".$key->idRole."\"><button type=\"button\" class=\"btn btn-rounded btn-danger btn-block\" title=\"Hapus\"><span class=\"fa fa-trash-o\"></span></button></a></td>
                                                </tr>
                                            </table>
                                        </td>
                                        </tr>";
